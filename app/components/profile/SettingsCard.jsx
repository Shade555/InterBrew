...
export default function SettingsCard() {
  ...
  useEffect(() => {
    const getUser = async () => {
      ...
      if (!supabase) {
        console.log("Supabase not available for settings");
  ...
  const handleSave = async () => {
    // Handle missing Supabase client
    if (!supabase) {
      alert("Supabase not configured. Profile editing disabled.");
      return;
    }
  ...
  const handleDeleteAccount = async () => {
    // Handle missing Supabase client
    if (!supabase) {
      alert("Supabase not configured. Account deletion disabled.");
      return;
    }
